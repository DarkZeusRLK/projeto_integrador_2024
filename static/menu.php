<header>
  ...
  <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10m0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6"/>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="nav-item">
                                <a id="nav-link" class="nav-link" href="../page/whisky.php">Lidianópolis</a>
                            </li>
                            <li class="nav-item">
                                <a id="nav-link" class="nav-link" href="../page/rum.php">Grandes Rios</a>
                            </li>
                            <li class="nav-item">
                                <a id="nav-link" class="nav-link" href="../page/vinhos.php">Rio Branco do Ivaí</a>
                            </li>
                        </ul>
                        <li class="nav-item">
                        <a class="nav-link" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-ticket-detailed-fill" viewBox="0 0 16 16">
  <path d="M0 4.5A1.5 1.5 0 0 1 1.5 3h13A1.5 1.5 0 0 1 16 4.5V6a.5.5 0 0 1-.5.5 1.5 1.5 0 0 0 0 3 .5.5 0 0 1 .5.5v1.5a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 0 11.5V10a.5.5 0 0 1 .5-.5 1.5 1.5 0 1 0 0-3A.5.5 0 0 1 0 6zm4 1a.5.5 0 0 0 .5.5h7a.5.5 0 0 0 0-1h-7a.5.5 0 0 0-.5.5m0 5a.5.5 0 0 0 .5.5h7a.5.5 0 0 0 0-1h-7a.5.5 0 0 0-.5.5M4 8a1 1 0 0 0 1 1h6a1 1 0 1 0 0-2H5a1 1 0 0 0-1 1"/>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#"><img src="Imagens/bed.png" width="16" alt=""> Hotéis</a>
                    </li>
                    <li class="nav-item">
